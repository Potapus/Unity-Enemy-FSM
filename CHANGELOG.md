...
All notable changes to Enemy FSM will be documented in this file.
...
### Added
- Generic `StateMachine<TStateID, TContext>` core usable for any game object
...
- Demo scene with player movement, camera follow, and a working melee enemy
